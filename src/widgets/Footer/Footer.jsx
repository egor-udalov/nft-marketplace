            ...
            <div class="content-container">
                <div className={Style.footer__body}>
                    ...
                    <div className={Style.footerLogo}>
                        <img src="images/logo_header.svg" alt="" loading="lazy" className={Style.footerLogo__icon} />
                        <img src="images/nft_marketplace.svg" alt="" loading="lazy" className={Style.footerLogo__name} />
                    </div>

                    <p className={Style.footer__info}>NFT marketplace UI created with Anima for Figma.</p>
                    ...
                    <h5 className={`${Style.footer__subtitle} ${Style.footer__subtitle1}`}>Explore</h5>

                    <div className={Style.footer__wrapperPageLinks}>
                        <a href="#" className={Style.footer__pageLink}>Marketplace</a>
                        <a href="#" className={Style.footer__pageLink}>Rankings</a>
                        <a href="#" className={Style.footer__pageLink}>Connect a wallet</a>
                    </div>

                    <h5 className={`${Style.footer__subtitle} ${Style.footer__subtitle2}`}>Join our weekly digest</h5>
                ...
                <span className={Style.footer__copyrightMark}>Ⓒ NFT Market. Use this template freely.</span>
